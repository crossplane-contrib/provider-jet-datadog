...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LevelObjectiveObservation) DeepCopyInto(out *LevelObjectiveObservation) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LevelObjectiveObservation.
func (in *LevelObjectiveObservation) DeepCopy() *LevelObjectiveObservation {
	if in == nil {
		return nil
	}
	out := new(LevelObjectiveObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LevelObjectiveParameters) DeepCopyInto(out *LevelObjectiveParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LevelObjectiveParameters.
func (in *LevelObjectiveParameters) DeepCopy() *LevelObjectiveParameters {
	if in == nil {
		return nil
	}
	out := new(LevelObjectiveParameters)
	in.DeepCopyInto(out)
	return out
}
